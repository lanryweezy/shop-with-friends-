    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-purple-500/30">
      ...
      <section className="relative pt-32 pb-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-6 duration-1000 drop-shadow-2xl">
            The Social Spine of <br /> Commerce.
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 drop-shadow-lg font-medium">
          ...
          <div className="flex items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
            <button
              ...
              className="bg-white text-black px-8 py-4 rounded-full font-semibold hover:bg-gray-200 transition-all flex items-center gap-2 group shadow-[0_0_20px_rgba(255,255,255,0.3)]"
            >
      ...
      <section className="py-24 px-6 bg-white/5 border-y border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 relative">
            ...
            <div className="md:row-span-2 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:border-purple-500/30 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Stat */}
                <div className="text-6xl font-black bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-4 tracking-tight">
                  2.5x
                </div>

                {/* Title */}
                <h3 className="text-2xl font-bold mb-3 text-white">Higher Conversion</h3>
            ...
            {/* Card 2 - Bigger Carts */}
            <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:border-pink-500/30 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Stat */}
                <div className="text-5xl font-black bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent mb-3 tracking-tight">
                  +45%
                </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:border-emerald-500/30 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Stat */}
                <div className="text-5xl font-black bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent mb-3 tracking-tight">
                  3x
                </div>
      ...
      <section className="py-20 px-6 bg-white/5 border-y border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Install in 5 Minutes</h2>
            <p className="text-gray-400 text-lg">Works with Shopify, WooCommerce, or any platform. No complicated setup.</p>
          </div>
