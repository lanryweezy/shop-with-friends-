...
class SyncEngine {
  ...
  // Mock methods to satisfy interface if needed by App.tsx, though App.tsx mostly uses send/subscribe
  public async createSession(): Promise<string> { return "DEMO_SESSION"; }
  public async joinSession(id: string): Promise<void> { }
  public getClientId(): string | null { return "demo-client"; }
  public getSessionId(): string | null { return "DEMO_SESSION"; }
